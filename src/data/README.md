...
> **Status:** scaffold (empty). FHIR sandbox reference lives in `planning/code-templates/fhir_sandbox.docker.md`.
...
**Two-track providers:**
- **Mock repositories + `MockSensorSource`** — Track A (Expo Go). Plain (or in-memory) storage seeded from the
  synthetic persona pack (`planning/notebooks/03_...`); synthetic vitals streams per use case.
