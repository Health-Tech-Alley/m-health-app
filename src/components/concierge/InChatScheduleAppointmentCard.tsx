 ...
 * Mirrors the Schedule tab create fields; persists via local insertAppointment.
 */
...
export function InChatScheduleAppointmentCard({
  ...
  return (
    <View style={styles.card}>
      <Text style={styles.title}>Schedule a follow-up?</Text>
      <Text style={styles.body}>
        Health Monitor suggests professional follow-up (not an emergency). Book
        an appointment now, or dismiss to continue without scheduling.
      </Text>
      ...
      <View style={styles.actions}>
        ...
        >
          {busy ? (
            ...
            <Text style={styles.buttonPrimaryText}>Schedule appointment</Text>
          )}
        </Pressable>
        <Pressable
