    ...
    <View style={styles.panel}>
      ...
      <Row label="Pipeline">
        ...
        {result.emergencyResult.emergency && result.emergencyResult.reason && (
          <View style={[styles.badge, { backgroundColor: severityColor(3) }]}>
      ...
      <Row label="Anomaly">
        <View
          style={[
            styles.badge,
            { backgroundColor: result.isAnomaly ? severityColor(3) : severityColor(0) },
          ]}
        >
          <Text style={styles.badgeText}>
      ...
      <Row label="Severity">
        <View
          style={[styles.badge, { backgroundColor: severityColor(result.finalDecision.final_severity) }]}
        >
          <Text style={styles.badgeText}>
      ...
      <Row label="Concierge refinement queued">
        <Text style={styles.valueText}>
      ...
      {payloadsOpen && (
        <ScrollView style={styles.payloadBox}>
          ...
          {result.finalSLMPayload && (
            <>
              <Text style={styles.payloadLabel}>Final Concierge payload</Text>
              <Text style={styles.payloadJson}>
