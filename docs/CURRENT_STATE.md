...
- Concierge: `llama.rn` — **Gemma-4-E2B-it Q4_K_M** (default) + **Bonsai-8B Q1_0 1-bit** (alternate, experimental, Metal GPU) + **LFM2.5-2.6B Q4_K_M** (experimental, CPU-first, bounded-shallow FAST tier) via `src/inference/model-catalog.ts`
